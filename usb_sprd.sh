...
sudo /bin/sh -c 'echo 1782 4026 > /sys/bus/usb-serial/drivers/generic/new_id'
sudo /bin/sh -c 'echo 1782 4027 > /sys/bus/usb-serial/drivers/generic/new_id'
sudo /bin/sh -c 'echo 1782 4028 > /sys/bus/usb-serial/drivers/generic/new_id'
sudo /bin/sh -c 'echo 1782 4029 > /sys/bus/usb-serial/drivers/generic/new_id'
sudo /bin/sh -c 'echo 1782 4030 > /sys/bus/usb-serial/drivers/generic/new_id'
sudo /bin/sh -c 'echo 1782 4031 > /sys/bus/usb-serial/drivers/generic/new_id'
sudo /bin/sh -c 'echo 1782 4032 > /sys/bus/usb-serial/drivers/generic/new_id'
sudo /bin/sh -c 'echo 1782 4033 > /sys/bus/usb-serial/drivers/generic/new_id'
sudo /bin/sh -c 'echo 1782 402A > /sys/bus/usb-serial/drivers/generic/new_id'
sudo /bin/sh -c 'echo 1782 0925 > /sys/bus/usb-serial/drivers/generic/new_id'
sleep 1
echo "usb_sprd start"
